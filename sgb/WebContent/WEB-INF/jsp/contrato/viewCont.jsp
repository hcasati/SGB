...
<nav class="navbar navbar-inverse">
 ...
 <h3 class="page-header">Visualizar Contrato</h3>
 <div class="row">
 <div class="col-md-10">
 <p><strong>Nome | Raẓo Social:</strong></p>
 <p>{Valor do Campo}</p>
</div> 
<div class="col-md-2">
 <p><strong>Dia de Pagamento:</strong></p>
 <p>{Valor do Campo}</p>
</div> 
<div class="col-md-3">
...
<div class="col-md-2">
 <p><strong>Contrato | Fornecedor:</strong></p>
 <p>{Valor do Campo}</p>
</div> 
<div class="col-md-2">
...
<div id="actions" class="row">
 <div class="col-md-12">
   ...
   <a class="btn btn-primary" href="<c:url value="/contrato/viewEditAddCont"/>">Voltar</a>
  <a class="btn btn-default" href="<c:url value="/contrato/editBol"/>">Editar</a>
