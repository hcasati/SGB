	...
	<html lang="en">
	<head>
	  <title>Adicionar - Editar e Visualizar Usuário</title>
	  <meta charset="utf-8">
...
<nav class="navbar navbar-inverse">
 ...
 <div id="top" class="row">
    ...
    <div class="col-md-3">
        <a class="btn btn-primary pull-right h2" href="<c:url value="/usuarios/addUser"/>">Novo Usuário</a>
    </div>
</div> <!-- /#top -->
        ...
        <table class="table table-striped" cellspacing="0" cellpadding="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>123456</td>
                    <td class="actions">
                        <a class="btn btn-success btn-xs" href="<c:url value="/usuarios/viewUser"/>">Visualizar</a>
                        <a class="btn btn-warning btn-xs" href="<c:url value="/usuarios/editUser"/>">Editar</a>
