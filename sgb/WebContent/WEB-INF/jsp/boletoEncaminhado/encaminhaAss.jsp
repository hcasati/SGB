	...
	<html lang="en">
	<head>
	  <title> Encaminhar boletos Assistente</title>
	  <meta charset="utf-8">
  ...
  <div class="container-fluid">
    ...
    <div>
	  ...
	  <li><a href="<c:url value="/index/indexAss"/>"><span class="glyphicon glyphicon-home"></span> Home </a></li>
	  	          <li><a href="#"><span class="glyphicon glyphicon-user"></span> Assitente </a></li>
  ...
  <table class="table table-striped" cellspacing="0" cellpadding="0">
    ...
    <tbody>
	  ...
	  <tr>
        ...
        <td>Analista</td>
        <td>Assistente</td>
        <td><button type="button" class="btn btn-warning btn-xs">Erro cód-barras</button> <span class="glyphicon glyphicon-folder-open"></span> </td>
		      </tr>
	  <tr>
        <td>1003</td>
        <td>Locadora zxwy</td>
