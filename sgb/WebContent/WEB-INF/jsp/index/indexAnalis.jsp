...
<nav class="navbar navbar-inverse">
  ...
  <a  class="btn btn-primary" href="<c:url value="/boletoEncaminhado/encaminhaAnalis"/>">Encaminhar Boleto</a>
  <a  class="btn btn-primary" href="<c:url value="/relatorios/relatorioAnalis"/>">Relatórios Gerenciais</a>
