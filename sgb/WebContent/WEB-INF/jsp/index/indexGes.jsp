...
<nav class="navbar navbar-inverse">
  ...
  <a  class="btn btn-primary" href="<c:url value="/boletoEcaminhado/encaminhaGes"/>">Encaminhar Boleto</a>
  <a  class="btn btn-primary" href="<c:url value="/relatorios/relatoriosGes"/>">Relatórios Gerenciais</a>
  </td>
</div>
</div>
<br><br>
